...
| id                              | The id of the item in the database, which can be used to [query detail contract](contract.md#query-detail-contract)                                                                                                             | integer |
...
| address                         | The address of the contract. The response will be null after calling this interface. After several seconds, it can call [query contract](contract.md#query-detail-contract) according to the id.                                | string  |
...
| status                          | The status of the transaction. 0-pending, 1-success, 2-failed. The response will be 0 after calling this interface. After several seconds, it can call [query contract](contract.md#query-detail-contract) according to the id. | integer |
| tx\_id                          | The id of the transaction                                                                                                                                                                                                       | integer |
| hash                            | The hash of the transaction. The response will be null after calling this interface. After several seconds, it can call [query contract](contract.md#query-detail-contract) according to the id.                                | string  |
{% endtab %}
